...
class Zydra():
    ...
    def banner(self):
        ...
        banner = pyfiglet.figlet_format("ZIP_CRK™", font=bannerfont).replace("\n", "\n\t\t", 7)
		
        cprint("\r\n\t" + "@" * 61, "green", end="")
        cprint("\n\t\t" + banner + "\t\tAuthor : Noob Hacker (youtub=techbanglaahm)", "red", attrs=['bold'])
        cprint("\t" + "@" * 61 + "\n", "green")
    ...
    def main(self):
        ...
        usage = "%prog [options] [args]" \
                ...
                "\n\nBrute force Mode:" \
                "\n   %prog -f <file> -b <char_type> -m <minimum_length> -x <maxmimum_length>" \
                "\n\n   Available char_type:" \
                ...
                "\n\tExample: %prog -f <file> -b <space,digits,lettee,symbol> -m 1 -x 8"
